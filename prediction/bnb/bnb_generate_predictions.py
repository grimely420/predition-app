#!/usr/bin/env python3
"""
BNB prediction generator - calls API every 5 minutes.
"""
...
from bnb.config import API_HOST, API_PORT, PREDICTION_HORIZON, SYMBOL

# Setup logging
logger = setup_logging("BNB-Generator")
...
def make_prediction() -> bool:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get('success'):
                logger.info(
                    f"Prediction: ${data['predicted_price_5min']:,.2f} "
