#!/usr/bin/env python3
"""
Fixed BNB feature engineering - uses ALL available data properly.
"""
...
from bnb.config import DB_PATH

# Setup logging
logger = setup_logging("BNB-Engine")
...
def compute_features(target_timeframes: List[int] = [1, 5], 
    ...
    try:
        ...
        # Volume proxy (just count of ticks in minute - if available)
        # Target: future price change (5 minutes ahead)
...
def get_data_info() -> dict:
    ...
    try:
        ...
        return {
            ...
            'min_required_for_training': 800,
            'ready_for_training': price_count >= 800
        }
    except Exception as e:
...
if __name__ == "__main__":
    ...
    print("Testing BNB feature engineering...")
