#!/usr/bin/env python3
"""
BNB advanced model training with ensemble and regime detection.
"""
...
def main():
    print("="*60)
    print("BNB Advanced Model Training")
    print("="*60)
    ...
    success = run_advanced_training('BNB', DB_PATH, MODEL_DIR, PREDICTION_HORIZON)
    ...
    if success:
        ...
        print("Make sure you have at least 800 data points collected.")
